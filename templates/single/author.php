...
$user_member = get_user_meta(get_the_author_meta('ID'),'user_member',true);
?>
<section class="single-author">
    <?php echo $user_avatar; ?>
    <a href="<?php echo (get_the_permalink($user_member))? get_the_permalink($user_member) : '#'; ?>" title="<?php echo $display_name; ?>">
