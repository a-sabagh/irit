    ...
    <section class="one container">
        <div class="col-md-8 slider-wrapper pull-left-md">
            <div class="slider full-slider">
                <a href="#" class="slide">
                    <img src="<?php echo trailingslashit(IRTT_FRONT); ?>images/slider/slider.jpg" alt="" class="img-responsive slider-img">
                    <div class="slider-body">
                        <h3 class="item-title">لورم ایپسوم متن ساختگی</h3>
                        <p class="item-excerpt">تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط</p>
                    </div>
                    <!--.slider-body-->
                </a>
                <!--.slide-->
                <a href="#" class="slide">
                    <img src="<?php echo trailingslashit(IRTT_FRONT); ?>images/slider/slider2.jpg" alt="" class="img-responsive slider-img">
                    <div class="slider-body">
                        <h3 class="item-title">لورم ایپسوم متن ساختگی</h3>
                        <p class="item-excerpt">تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط</p>
                    </div>
                ...
                <!--.slide-->
                <a href="#" class="slide">
                    <img src="<?php echo trailingslashit(IRTT_FRONT); ?>images/slider/slider3.jpg" alt="" class="img-responsive slider-img">
                    <div class="slider-body">
                        <h3 class="item-title">لورم ایپسوم متن ساختگی</h3>
                        <p class="item-excerpt">تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط</p>
                    </div>
            ...
            <div class="box">
                ...
                <div class="box-content home-featured-product">
                    <ul class="featured-product">
                        <li>
                            <a href="#">
                                <img src="<?php echo trailingslashit(IRTT_FRONT); ?>images/product.jpg" alt="" class="img-responsive">
                            </a>
                        </li>
                        <li>
                            <a href="#">
            ...
            <div class="col-md-6 featured-blog  left-border">
                <div class="featured-tab-container right-tab">
                    <div class="featured-head">
                        <h3>پژوهش</h3>
                        <ul>
                            <li class="active"><a href="#">اقتصاد بین الملل</a></li>
                            <li><a href="#">حقوق بین الملل</a></li>
                        </ul>
                    </div>
                    <!--.featured-head-->
                    <div class="featured-content">
                        <div class="tab-menu-content">
                            <a href="#" class="article-1 full-featured-article">
                                <img src="<?php echo trailingslashit(IRTT_FRONT); ?>images/thumb4.jpg" class="img-responsive" alt="" />
                                <div class="article-body full-article-body">
                                    <h3>بهبود ابزارهای کاربردی</h3>
                                    <p>حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها </p>
                                </div>
                            </a>
                            <div class="article-half-wrapper">
                                <a href="#" class="article-1 article-half">
                                    <img src="<?php echo trailingslashit(IRTT_FRONT); ?>images/thumb3.jpg" class="img-responsive" alt="" />
                                    <div class="article-body half-article-body">
                                        <p>حال و آینده شناخت فراوان جامعه و تا با نرم افزارها </p>
                                    </div>
                                </a>
                                <a href="#" class="article-1 article-half">
                                    <img src="<?php echo trailingslashit(IRTT_FRONT); ?>images/thumb4.jpg" class="img-responsive" alt="" />
                                    <div class="article-body half-article-body">
                                        <p>حال و آینده شناخت فراوان می طلبد تا با نرم افزارها </p>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="tab-menu-content">
                            ...
                            <div class="article-half-wrapper">
                                ...
                                <a href="#" class="article-1 article-half">
                                    <img src="<?php echo trailingslashit(IRTT_FRONT); ?>images/thumb5.jpg" class="img-responsive" alt="" />
                                    <div class="article-body half-article-body">
                                        <p>حال و آینده شناخت فراوان می طلبد تا با نرم افزارها </p>
                                    </div>
                                </a>
            ...
            <div class="col-md-6 featured-blog">
                <div class="featured-tab-container left-tab">
                    <div class="featured-head">
                        <h3>اخبار</h3>
                        <ul>
                            <li class="active"><a href="#">آمریکا</a></li>
                            <li><a href="#">اخبار بین الملل</a></li>
                        </ul>
                    </div>
                    <!--.featured-head-->
                    <div class="featured-content">
                            ...
                            <div>
                                <a href="#" title="">
                                    ...
                                    <div class="product-description">
                                        <h3>محصول یک</h3>
                                        <del><span class="amount">۳۰۰۰ تومان</span></del>
                                        <span>۲۰۰۰ تومان</span>
                                    </div>
            ...
            <div class="col-md-7 product-tab-wrapper">
                <div class="featured-tab-container left-tab">
                    <div class="featured-head">
                        <h3>محصولات</h3>
                        <ul>
                            <li class="active"><a href="#">کتاب</a></li>
                            <li><a href="#">سخنرانی</a></li>
                        </ul>
                    </div>
                    <!--.featured-head-->
                    <div class="featured-content">
            ...
            <div class="col-md-8 left-border">
                <div class="box">
                    ...
                    <div class="box-content ht-blog-box">
                        <a href="#" title="" class="ht-blog-item">
                            <img src="<?php echo trailingslashit(IRTT_FRONT); ?>images/thumb2.jpg" class="img-responsive" alt="">
                            <h3>رهبری عربستان در بین الملل</h3>
                            <span>عبدالمجید زواری</span>
                        </a>
                        <a href="#" title="" class="ht-blog-item">
                            <img src="<?php echo trailingslashit(IRTT_FRONT); ?>images/thumb2.jpg" class="img-responsive" alt="">
                            <h3>رهبری عربستان در بین الملل</h3>
