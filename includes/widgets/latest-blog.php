    ...
    public function widget($args, $instance) {
        ...
        if ($visual_blog_query->have_posts()):
            while ($visual_blog_query->have_posts()):
                ...
                $default_blog_thumb = strip_tags(stripcslashes(get_option('srng_default_blog_thumb')));
                $output .= "<li>";
                if (!empty($post_thumbnail_id)) {
                    ...
                    $output .= '<a class="img-block" href="' . get_the_permalink() . '" title="' . get_the_title() . '"><img class="img-responsive" src="' . $default_blog_thumb . '" alt="' . $thumbnail_alt . '"></a>';
                }
